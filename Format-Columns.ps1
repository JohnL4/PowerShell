...
function Format-Columns {
	...
	process { $values += $InputObject }
        ...
        # This step probably precludes any further processing on whether the item is a container or not (or based on
        # other attributes), since we throw all info but whatever ToString() returns.
